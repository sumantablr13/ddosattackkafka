...
/**
  ...
  *
  * */
abstract class AbstractDaqeSSTTbl2(appContext: AppContext) extends PartitionTable("") {
  override lazy val logicalName: String = "SellOut drug redeemed per month"
  override lazy val physicalName: String = "dk9_sst_tbl_2_load"
