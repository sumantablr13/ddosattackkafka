...
abstract class AbstractDspnsdRxTransAcq(appContext: AppContext) extends PartitionTable("") {

  override lazy val logicalName: String = "Dispensed Prescription Transaction Acquisition"
  override lazy val physicalName: String = "dspnsd_rx_trans_acq"

  override lazy val tableColumns = Array(
    ("dspnsd_rx_trans_id", "STRING")
    , ("panel_mbr_cd", "STRING")
    , ("rx_dspnsd_tm_pd_id", "INTEGER")
    ...
    , ("supld_dspnsd_rx_item_seq_nbr", "INTEGER")
    , ("supld_rx_dspnsd_dt", "INTEGER")
    , ("supld_rx_dspnsd_tm", "INTEGER")
    ...
    , ("supld_rx_fill_typ_cd", "INTEGER")
    , ("supld_rx_fill_st_cd", "STRING")
    , ("supld_cdd_genl_practnr_qty_txt", "STRING")
    , ("supld_dspnsd_qty", "STRING")
    , ("supld_pscr_qty", "STRING")
    , ("supld_dspnsd_rx_item_uom_cd", "STRING")
    , ("supld_dspnsd_rx_item_uom_txt", "STRING")
    , ("supld_dspnsd_multilex_pip_id", "STRING")
    , ("supld_pscr_multilex_pip_id", "STRING")
    , ("supld_dspnsd_mediphase_pip_id", "STRING")
    , ("supld_pscr_mediphase_pip_id", "STRING")
    , ("supld_dspnsd_pip_id", "STRING")
    , ("supld_pscr_pip_id", "STRING")
    , ("supld_dspnsd_prosper_id", "STRING")
    , ("supld_pscr_prosper_id", "STRING")
    , ("supld_dspnsd_link_id", "STRING")
    , ("supld_pscr_link_id", "STRING")
    , ("supld_dspnsd_dmd_id", "STRING")
    , ("supld_pscr_dmd_id", "STRING")
    , ("supld_dspnsd_nexphase_id", "STRING")
    , ("supld_pscr_nexphase_id", "STRING")
    , ("supld_dspnsd_mps_id", "STRING")
    , ("supld_pscr_mps_id", "STRING")
    , ("supld_dspnsd_proscript_id", "STRING")
    , ("supld_pscr_proscript_id", "STRING")
    ...
    , ("supld_dspnsd_generic_pcmdty_ind", "INTEGER")
  ...
  override lazy val schema = (new StructType)
    ...
    .add("supld_cdd_genl_practnr_qty_txt", StringType)
    ...
    .add("supld_dspnsd_multilex_pip_id", StringType)
    .add("supld_pscr_multilex_pip_id", StringType)
    .add("supld_dspnsd_mediphase_pip_id", StringType)
    .add("supld_pscr_mediphase_pip_id", StringType)
    .add("supld_dspnsd_pip_id", StringType)
    .add("supld_pscr_pip_id", StringType)
    .add("supld_dspnsd_prosper_id", StringType)
    .add("supld_pscr_prosper_id", StringType)
    .add("supld_dspnsd_link_id", StringType)
    .add("supld_pscr_link_id", StringType)
    .add("supld_dspnsd_dmd_id", StringType)
    .add("supld_pscr_dmd_id", StringType)
    .add("supld_dspnsd_nexphase_id", StringType)
    .add("supld_pscr_nexphase_id", StringType)
    .add("supld_dspnsd_mps_id", StringType)
    .add("supld_pscr_mps_id", StringType)
    .add("supld_dspnsd_proscript_id", StringType)
    .add("supld_pscr_proscript_id", StringType)
  ...
  def helperCreatePartitionSpec(procEffDt: Int,dervdDsuppProcId:String): String = s"proc_eff_dt=CAST('${procEffDt}' AS INT), dervd_dsupp_proc_id='${dervdDsuppProcId}'"
}
