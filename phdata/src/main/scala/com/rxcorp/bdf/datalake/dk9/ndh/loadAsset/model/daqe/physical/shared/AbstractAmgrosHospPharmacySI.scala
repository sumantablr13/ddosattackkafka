...
/**
  ...
  *
  * */
abstract class AbstractAmgrosHospPharmacySI(appContext: AppContext) extends PartitionTable("") {
  override lazy val logicalName: String = "Sell In Amgros Hosp Pharmacy"
  override lazy val physicalName: String = "dk9_amgros_hosp_pharmy_si_load"
