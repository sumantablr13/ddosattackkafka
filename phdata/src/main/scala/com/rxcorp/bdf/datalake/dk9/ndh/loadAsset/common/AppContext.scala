...
import com.rxcorp.bdf.datalake.dk9.ndh.loadAsset.common.executor.{ImpalaExecutor, RestfulServiceExecutor, SftpExecutor, SparkExecutor}
import com.rxcorp.bdf.logging.internal.{LoggingConf, Settings}
...
/**
  * Set of basic application properties (common for all ndh dk9 services)
  *
