...
import org.apache.spark.sql.types.{DecimalType, IntegerType, LongType, StringType, StructType, TimestampType}

/**
  * @author rdas2 on 9/22/2020
  *
  * */
abstract class AbstractNdhTransSumAcq(appContext: AppContext) extends PartitionTable("") {
  override lazy val logicalName: String = "SellOut Transaction Sum Acquisition"
  override lazy val physicalName: String = "dk9_so_trans_sum_acq"
